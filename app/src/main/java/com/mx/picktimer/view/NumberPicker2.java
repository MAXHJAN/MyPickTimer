...
/**
 * Created by maxiao on 2017/7/12.
 */
    ...
    public class NumberPicker2 extends LinearLayout {
         ...
         */
        private int mScrollState = android.widget.NumberPicker.OnScrollListener.SCROLL_STATE_IDLE;
        ...
        public interface OnScrollListener {
             ...
             *            {@link #SCROLL_STATE_IDLE}.
             */
            public void onScrollStateChange(android.widget.NumberPicker view, @ScrollState int scrollState);
        }
        ...
        public NumberPicker(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            mAdjustScroller = new android.widget.Scroller(getContext(), new DecelerateInterpolator(2.5f));
            ...
            switch (action) {
                case MotionEvent.ACTION_DOWN: {
                    ...
                    if (mLastDownEventY < mTopSelectionDividerTop) {
                        if (mScrollState == android.widget.NumberPicker.OnScrollListener.SCROLL_STATE_IDLE) {
                    ...
                    if (!mFlingScroller.isFinished()) {
                        ...
                        onScrollStateChange(android.widget.NumberPicker.OnScrollListener.SCROLL_STATE_IDLE);
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            switch (action) {
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if (mScrollState != android.widget.NumberPicker.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL) {
                        int deltaDownY = (int) Math.abs(currentMoveY - mLastDownEventY);
                        if (deltaDownY > mTouchSlop) {
                            removeAllCallbacks();
                            onScrollStateChange(android.widget.NumberPicker.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
                        }
                    } else {
                ...
                case MotionEvent.ACTION_UP: {
                    ...
                    if (Math.abs(initialVelocity) > mMinimumFlingVelocity) {
                        ...
                        onScrollStateChange(android.widget.NumberPicker.OnScrollListener.SCROLL_STATE_FLING);
                    } else {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (showSelectorWheel && mVirtualButtonPressedDrawable != null
                    && mScrollState == android.widget.NumberPicker.OnScrollListener.SCROLL_STATE_IDLE) {
        ...
        class PressedStateHelper implements Runnable {
            ...
            public void buttonPressDelayed(int button) {
                ...
                android.widget.NumberPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
            }
                ...
                switch (mMode) {
                    ...
                    case MODE_TAPPED: {
                        switch (mManagedButton) {
                            case BUTTON_INCREMENT: {
                                if (!mIncrementVirtualButtonPressed) {
                                    android.widget.NumberPicker.this.postDelayed(this,
        ...
        class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
                    ...
                    case VIRTUAL_VIEW_ID_INPUT: {
                        switch (action) {
                            case AccessibilityNodeInfo.ACTION_FOCUS: {
                                if (android.widget.NumberPicker.this.isEnabled() && !mInputText.isFocused()) {
                        ...
                        switch (action) {
                            case AccessibilityNodeInfo.ACTION_CLICK: {
                                if (android.widget.NumberPicker.this.isEnabled()) {
                                    ...
                                    android.widget.NumberPicker.this.changeValueByOne(increment);
                                    sendAccessibilityEventForVirtualView(virtualViewId,
                                            AccessibilityEvent.TYPE_VIEW_CLICKED);
                                    return true;
                                }
            ...
            private void sendAccessibilityEventForVirtualText(int eventType) {
                if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                    ...
                    event.setSource(android.widget.NumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
                    requestSendAccessibilityEvent(android.widget.NumberPicker.this, event);
                }
            }
            ...
            private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
                ...
                if (AccessibilityManager.getInstance(mContext).isEnabled()) {
                    ...
                    event.setEnabled(android.widget.NumberPicker.this.isEnabled());
                    event.setSource(android.widget.NumberPicker.this, virtualViewId);
                    requestSendAccessibilityEvent(android.widget.NumberPicker.this, event);
                }
            }
            ...
            private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText(
                ...
                info.setSource(android.widget.NumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
            ...
            private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
                ...
                info.setSource(android.widget.NumberPicker.this, virtualViewId);
                info.setParent(android.widget.NumberPicker.this);
                info.setText(text);
                info.setClickable(true);
                info.setLongClickable(true);
                info.setEnabled(android.widget.NumberPicker.this.isEnabled());
                Rect boundsInParent = mTempRect;
                boundsInParent.set(left, top, right, bottom);
                info.setVisibleToUser(isVisibleToUser(boundsInParent));
                info.setBoundsInParent(boundsInParent);
            ...
            private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
                ...
                info.setPackageName(mContext.getPackageName());
                info.setSource(android.widget.NumberPicker.this);

                if (hasVirtualDecrementButton()) {
                    info.addChild(android.widget.NumberPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
                }
                info.addChild(android.widget.NumberPicker.this, VIRTUAL_VIEW_ID_INPUT);
                if (hasVirtualIncrementButton()) {
                    info.addChild(android.widget.NumberPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
                }
